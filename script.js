const T = {
  fr: {
    ...
    c6_title:'Oracle Certified Professional', c6_sub:'Java SE 8 — Oracle Corporation',
    c6_desc:"Certification avancée Oracle validant la maîtrise approfondie de Java SE 8 : programmation fonctionnelle, Stream API, Optional, Date/Time API, lambdas et concurrence avancée.",
  ...
  en: {
    ...
    c6_title:'Oracle Certified Professional', c6_sub:'Java SE 8 — Oracle Corporation',
    c6_desc:'Advanced Oracle certification validating deep mastery of Java SE 8: functional programming, Stream API, Optional, Date/Time API, lambdas and advanced concurrency.',
    c2_title:'Oracle Certified Professional', c2_sub:'Java SE 17 — Oracle Corporation',
